...
export default function ProjectBox({ projectData }) {
    ...
    // Modal logic or other JS functionality
        ...
        <>
            <div className="col-md-6 col-lg-4 col-sm-12 mb-4   w-100 ">
                <div className="project-info projectBox p-2">
                    ...
                    <video className="img-fluid w-100 rounded-vid border border-secondary" ref={videoRef} controls autoPlay muted loop>
                    ...
                    <div className="d-flex flex-row justify-content-center flex-wrap ">
                        {projectData?.modalsArray?.map((modalData, i) =>
                            <div key={projectData.videoPath + i}  className='p-1 '>
                                <button className=" w-100 btn custom-btn custom-btn-project "
                                    onClick={() => {
                                        setShowInfo(true)
